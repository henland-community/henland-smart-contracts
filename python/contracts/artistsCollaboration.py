...
class ArtistsCollaboration(sp.Contract):
    ...
    def __init__(self):
        ...
        self.init_type(sp.TRecord(
            ...
            proposals=sp.TBigMap(sp.TNat, ArtistsCollaboration.PROPOSAL_TYPE),
    ...
    def execute_proposal(self, proposal_id):
        ...
        lambda_function = sp.view(
            ...
            t=LambdaProvider.LAMBDA_FUNCTION_TYPE).open_some()
...
class ArtistsCollaborationOriginator(sp.Contract):
    ...
    def __init__(self, metadata):
        ...
        """
        # Initialize the artists collaboration contract
        self.contract = ArtistsCollaboration()
        ...
        self.data.collaborations[self.data.counter] = sp.create_contract(
            ...
            storage=sp.record(
                ...
                proposals=sp.big_map(
                    tkey=sp.TNat, tvalue=ArtistsCollaboration.PROPOSAL_TYPE),
...
class LambdaProvider(sp.Contract):
    ...
    LAMBDA_RECORD_TYPE = sp.TRecord(
        ...
        enabled=sp.TBool,
        # The lambda function alias (e.g mint_objkt, swap_henland)
        alias=sp.TString,
        # The lambda function
    ...
    def __init__(self, administrator, metadata):
        ...
        self.init_type(sp.TRecord(
            ...
            lambdas=sp.TBigMap(
                sp.TNat, LambdaProvider.LAMBDA_RECORD_TYPE),
    ...
    def add_lambda(self, params):
        ...
        sp.set_type(params, sp.TRecord(
            lambda_id=sp.TNat,
            alias=sp.TString,
            lambda_function=LambdaProvider.LAMBDA_FUNCTION_TYPE).layout(
...
sp.add_compilation_target("artistsCollaboration", ArtistsCollaboration())

sp.add_compilation_target("artistsCollaborationOriginator", ArtistsCollaborationOriginator(
    metadata=sp.utils.metadata_of_url("ipfs://henlandxyz")))

sp.add_compilation_target("lambdaProvider", LambdaProvider(
