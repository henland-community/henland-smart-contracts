"""A smart contract where the Henland Core Team members can vote multi-option text
proposals.
...
class CoreTeamVote(sp.Contract):
    """This contract allows the Henland Core Team to vote multi-option text
    proposals.
    ...
    def __init__(self, metadata, core_team_multisig, minimum_votes):
        ...
        self.init_type(sp.TRecord(
            ...
            # The Henland Core Team Multisig contract address
    ...
    def check_is_user(self):
        ...
        the Henland Core Team multisig users.
    ...
    def set_minimum_votes(self, minimum_votes):
        ...
        # Check that the Henland Core Team multisig executed the entry point
