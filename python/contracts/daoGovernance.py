...
class DAOGovernance(sp.Contract):
    ...
    The contract is a combination of the Henland multisig wallet contract and the
    Murmuration and BaseDAO smart contracts:
      https://github.com/henland-community/henland-smart-contracts
...
# With smartpy-cli and henland_sc we can do some coverage and lint towards TZIP-16 compliance:
