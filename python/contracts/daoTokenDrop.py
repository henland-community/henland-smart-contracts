...
class DAOTokenDrop(sp.Contract):
    ...
    def __init__(self, administrator, metadata, token, treasury, merkle_root, expiration_date):
        ...
        self.contract_metadata = {
            "name": "Henland DAO token distribution contract",
            "description": "Token distribution contract used for the Henland DAO",
            "version": "1.0.0",
            "authors": ["Henland Community <https://twitter.com/HenlandCommunity>"],
            "homepage": "https://henland.xyz",
            "source": {
                "tools": ["SmartPy 0.16.0"],
                "location": "https://github.com/henland-community/henland-smart-contracts/blob/main/python/contracts/daoTokenDrop.py"
            },
            "license": {
                "name": "MIT",
...
sp.add_compilation_target("daoTokenDrop", DAOTokenDrop(
    ...
    metadata=sp.utils.metadata_of_url("ipfs://bafkreibsbxwhd7kusndrr7dv5er5xqiqc2zvuxw5qtd5ftsrozshr4brnq"),
    token=sp.address("KT1Bdh3NcpSnTy9kPGQLzBr9u51KHfPYqCnN"),
    treasury=sp.address("tz1Z2VHBKLmSLobfm5jqYEnJfVe1nKd1j66g"),
