...
class DAOTreasury(sp.Contract):
    ...
    def __init__(self, metadata, dao):
        ...
        self.contract_metadata = {
            "name": "Henland DAO treasury contract",
            "description": "Treasury contract used for the Henland DAO",
            "version": "1.0.0",
            "authors": ["Henland Community <https://twitter.com/HenlandCommunity>"],
            "homepage": "https://henland.xyz",
            "source": {
                "tools": ["SmartPy 0.16.0"],
                "location": "https://github.com/henland-community/henland-smart-contracts/blob/main/python/contracts/daoTreasury.py"
            },
            "license": {
                "name": "MIT",
