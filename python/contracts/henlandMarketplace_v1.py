"""The Henland Community marketplace contract.
...
class Marketplace(sp.Contract):
    """This contract implements the first version of the Henland Community
...
# Add a compilation target initialized to the Henland Community multisig and the OBJKT FA2 contract
