...
class Representatives(sp.Contract):
    ...
    Henland community representatives.
    ...
    def __init__(self, metadata, representatives, minimum_votes, expiration_time):
        ...
        self.init_type(sp.TRecord(
            ...
            # The Henland community representatives
            representatives=sp.TMap(sp.TAddress, sp.TString),
            # The Henland communities represented in the contract
        ...
        self.contract_metadata = {
            "name": "Henland representatives multisig wallet / mini-DAO",
            "description": "Multisig wallet contract used for the Henland representatives",
            "version": "1.0.0",
            "authors": ["Henland Community <https://twitter.com/HenlandCommunity>"],
            "homepage": "https://henland.xyz",
            "source": {
                "tools": ["SmartPy 0.16.0"],
                "location": "https://github.com/henland-community/henland-smart-contracts/blob/main/python/contracts/representatives.py"
            },
            "license": {
                "name": "MIT",
