    ...
    def __init__(self, minter_contract, metadata):
        ...
        contract_metadata = {
            ...
            "source": {
                ...
                "location": "https://github.com/henland-community/henland-smart-contracts/blob/main/python/contracts/subscriptionToken.py"
            },
...
sp.add_compilation_target("subscriptionToken", SubscriptionToken(
    minter_contract=sp.address("tz1Z2VHBKLmSLobfm5jqYEnJfVe1nKd1j66g"),
